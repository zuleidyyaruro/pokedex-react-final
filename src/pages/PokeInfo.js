...
const PokeInfo = () => {
    ...
    return (
        <>
            <NavBar />
            <div className='poke-info-container d-flex flex-column justify-content-center align-items-center '>
                <div className='poke-info-container-image'>
                    {
                        dataPokeId.sprites && <img className='mt-2' src={dataPokeId.sprites.other.dream_world.front_default} alt="" />
                    }
                </div>
            ...
            <div className='container mt-3'>
                ...
                <div className='poke-info-container-info p-2 d-flex justify-content-around rounded'>
                ...
                <div className='container-habilities d-flex justify-content-center rounded'>
                    {
                        ...
                        dataPokeId.abilities.map((element, i) => {
                            return <span className='span-moves text-center m-1 px-3 py-1 rounded text-capitalize' key={i + 1}>{element.ability.name}</span>
                        })
                    }
                </div>
            </div>
                ...
                <div className='container-moves'>
                    {
                        ...
                        dataPokeId.moves.map((element, i) => {
                            return <span className='span-moves text-center m-1 p-1 rounded text-capitalize' key={i + 1}>{element.move.name}</span>
                        })
                    }
                </div>
            </div>
